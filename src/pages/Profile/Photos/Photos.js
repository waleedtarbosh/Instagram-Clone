...
const Photos = ({ photos }) => {
  ...
  const svgComponentProps = [
    { svgProps: svgProps, pathProps: heartIconProps },
    { svgProps: svgProps, pathProps: commentIconProps },
  ];
              ...
              <div className="absolute bottom-0 left-0 bg-gray-200 z-10 w-full justify-evenly items-center h-full bg-black-faded group-hover:flex">
                <div className="flex justify-center items-center">
                  <div className={styles["icons"]}>
                    {svgComponentProps.map((props, index) => (
                      <p key={photo.id + index} className="flex items-center text-white font-bold">
